    ...
    class Title_NPC : public CreatureScript
    {
                        ...
                        bool OnGossipHello(Player * Player, Creature * Creature)
        {
                ...
                bool OnGossipSelect(Player * Player, Creature * Creature, uint32 sender, uint32 uiAction)
                {
                    ...
                    Player->ADD_GOSSIP_ITEM(4, name+" des dix tempêtes", GOSSIP_SENDER_MAIN, 6);
                    Player->ADD_GOSSIP_ITEM(4, name+" du Rêve d'émeraude", GOSSIP_SENDER_MAIN, 7);
                    ...
                    Player->ADD_GOSSIP_ITEM(4, "Maître de l'arène "+name, GOSSIP_SENDER_MAIN, 5);               
                    ...
                    break;
                                    ...
                                    Player->DestroyItemCount(TITLE_TOKEN, TITLE_PRICE, true);
                                                    ...
                                                    Player->SetTitle(titleInfo, false);
                                                    Creature->MonsterWhisper("Vous gagnez le titre Maître de l'arène!", Player->GetGUID());
                                                    Player->CLOSE_GOSSIP_MENU();
                                    }
                                    else
                                    {
                                    ...
                                    Player->DestroyItemCount(TITLE_TOKEN, TITLE_PRICE, true);
                                                    ...
                                                    Player->SetTitle(titleInfo, false);
                                                    Creature->MonsterWhisper("Vous gagnez le titre des dix tempêtes!", Player->GetGUID());
                                                    Player->CLOSE_GOSSIP_MENU();
                                    }
                                    else
                                    {
                                    ...
                                    Player->DestroyItemCount(TITLE_TOKEN, TITLE_PRICE, true);
                                                    ...
                                                    Player->SetTitle(titleInfo, false);
                                                    Creature->MonsterWhisper("Vous gagnez le titre du Rêve d'émeraude!", Player->GetGUID());
                                                    Player->CLOSE_GOSSIP_MENU();
                                    }
                                    else
                                    {
